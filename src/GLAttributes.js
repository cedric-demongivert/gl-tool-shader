...
export class GLAttributes {
  ...
  */
  set (name, normalized = false, stride = 0, offset = 0) {
    ...
    const size = this.scalarSizeof(name)
  ...
  */
  ...
  /**
  * Return the type of scalars that compose an attribute by using its name.
  *
  * @param {string} name - Name of the attribute to fetch.
  *
  * @return {number} The type of scalars that compose the requested attribute.
  */
  scalarTypeof (name) {
  ...
  /**
  * Return the number of scalars of an attribute by using its name.
  *
  * @param {string} name - Name of the attribute to fetch.
  *
  * @return {number} The number of scalars of the requested attribute.
  */
  scalarSizeof (name) {
    const context = this.context.context
  ...
  /**
  * Return the number of items of an attribute by using its name.
  *
  * @param {string} name - Name of the attribute to fetch.
  *
  * @return {number} The number of items of the requested attribute.
  */
  sizeof (name) {
